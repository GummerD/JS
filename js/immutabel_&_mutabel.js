...
console.log('как мы видим меод push является мутабельным, и чnобы не менять изначльаный массив можно воспользовать такой конструкцией imm = [...array, 103]');
imm = [...array, 103];
console.log('Изначальный массив array: ' + array + ' массив полученный через спред ' + imm);
